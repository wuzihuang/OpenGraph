...
await execa('./node_modules/.bin/vite', ['build'], { cwd: 'apps/web', stdio: 'inherit' });
...
await cp('apps/web/dist', 'plugins/graph/runtime/dashboard', { recursive: true, force: true });
await execa('./apps/web/node_modules/.bin/esbuild', [
